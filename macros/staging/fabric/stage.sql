{%- macro fabric__stage(include_source_columns,
                ldts,
                rsrc,
                source_model,
                hashed_columns,
...
{%- set derived_input_columns = extract_input_columns(derived_columns) -%} {# this enforces using the macro from this package #}
{% do log(derived_input_columns, true) %}
